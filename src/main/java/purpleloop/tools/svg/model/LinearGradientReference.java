...
public class LinearGradientReference extends SvgAbstractObject  implements LinearGradient, Paintable {

/** Class logger. */
private static final Logger logger = LogManager.getLogger(LinearGradientReference.class);
